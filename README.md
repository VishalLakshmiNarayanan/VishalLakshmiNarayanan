...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Risk-aware ML library implementing Loss-at-Risk regression, CVaR ensembles, and tail-focused evaluation for insurance and finance.</p>
    </td>
    <td width="50%" valign="top">
      <h3>Career Pulse</h3>
      ...
      <p>Semantic resume–job matching platform with transparent scoring across 48K+ AI/ML job listings.</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Transforms maps into interactive worlds with 3D visuals, narration, and cinematic effects.</p>
    </td>
    <td width="50%" valign="top">
      <h3>SlideSage AI</h3>
